...
public class ItemInit {
	...
	public static final RegistryObject<Item> RED_WINE_GLASS = ITEMS.register("red_wine_glass",
			() -> new WineGlassItem(new Item.Properties().stacksTo(1).craftRemainder(WINE_GLASS.get())));
	...
	public static final RegistryObject<Item> MARSHMALLOW_ON_A_STICK = ITEMS.register("marshmallow_on_a_stick",
			() -> new MarshmallowItem(
					new Item.Properties().food(FoodInit.MARSHMALLOW_ON_A_STICK).craftRemainder(Items.STICK)));
	...
	public static final RegistryObject<Item> ROASTED_MARSHMALLOW_ON_A_STICK = ITEMS
			.register("roasted_marshmallow_on_a_stick", () -> new MarshmallowItem(
					new Item.Properties().food(FoodInit.ROASTED_MARSHMALLOW_ON_A_STICK).craftRemainder(Items.STICK)));
	...
	public static final RegistryObject<Item> HAZEL_BOAT = ITEMS.register("hazel_boat",
			() -> new BoatItem(false, BoatEntity.Type.HAZEL, new Item.Properties()));
	...
	public static final RegistryObject<Item> SOUL_SHAKE = ITEMS.register("soul_shake",
			() -> new SoulDrinkItem(new Item.Properties().stacksTo(16).craftRemainder(Items.GLASS_BOTTLE)));

	public static final RegistryObject<Item> MILK_BOTTLE = ITEMS.register("milk_bottle",
			() -> new MilkBottleItem(new Item.Properties().stacksTo(16).craftRemainder(Items.GLASS_BOTTLE)));
