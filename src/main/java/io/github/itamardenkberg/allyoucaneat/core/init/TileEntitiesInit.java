...
public class TileEntitiesInit {
    ...
    public static final RegistryObject<BlockEntityType<SignBlockTileEntity>> SIGN_TILE_ENTITIES =
			BLOCK_ENTITES.register("sign_block_entity", () -> BlockEntityType.Builder.of(SignBlockTileEntity::new,
